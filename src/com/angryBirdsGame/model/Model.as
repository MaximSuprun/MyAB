package com.angryBirdsGame.model{
	...
	public class Model extends Actor implements IModel{		
				...
				for(var j:int=0;j<pColumnLength;j++){	
					...
					switch (_map[i][j]){
						case 7:
							...
							pVOPigData.friction=5;
							pVOPigData.density=5;
							pVOPigData.health=350;
							pVOPigData.radius=20;
							pVOPigData.type=Constants.BLOOD;
							if((i>=1)){
								if(_map[i-1][j]!=0){
							...
							break;
						case 1:
							pVOBlockData = createBodyBlock(_cellSize,_cellSize,Constants.WOOD_FRICTION,Constants.WOOD_DENSITY,Constants.MAX_HP_WOOD_BLOCK,Constants.WOOD);
							pVOBlockData.type=Constants.WOOD;
							break;
						case 2:
							pVOBlockData = createBodyBlock(_cellSize,_cellSize,Constants.STONE_FRICTION,Constants.STONE_DENSITY,Constants.MAX_HP_STONE_BLOCK,Constants.STONE);
							pVOBlockData.type=Constants.STONE;
							break;
						case 3:
							pVOBlockData = createBodyBlock(_cellSize*3,_cellSize/2,Constants.WOOD_FRICTION,Constants.WOOD_DENSITY,Constants.MAX_HP_WOOD_PLANK,Constants.WOOD_PLANK);
							pVOBlockData.type=Constants.WOOD;
							break;
						case 4:
							pVOBlockData = createBodyBlock(_cellSize*3,_cellSize/2,Constants.STONE_FRICTION,Constants.STONE_DENSITY,Constants.MAX_HP_STONE_PLANK,Constants.STONE_PLANK);
							pVOBlockData.type=Constants.STONE;
							break;
						case 5:
							pVOBlockData = createBodyBlock(_cellSize/3,_cellSize*2,Constants.WOOD_FRICTION,Constants.WOOD_DENSITY,Constants.MAX_HP_WOOD_PLANK,Constants.WOOD_PLANK);
							...
							break;
						case 6:
							pVOBlockData = createBodyBlock(_cellSize/2,_cellSize*2,Constants.STONE_FRICTION,Constants.STONE_DENSITY,Constants.MAX_HP_STONE_PLANK,Constants.STONE_PLANK);
							pVOBlockData.type=Constants.STONE;
							break;
					}
		...
		//
		//---------------------------------------------------------------------------------------------------------
		private function _allArrayDispose():void{
			_birdDataContainer=[];						
			_pigDataContainer=[];							
			_blocksDataContainer=[];
		}
